...
import { initializeGrid, moveTiles, isGameOver, hasReached2048 } from "../components/gameLogic";
...
const GamePage = () => {
  ...
  const handleKeyDown = (e) => {
    const { newGrid, newScore, newTiles, mergedTiles } = moveTiles(grid, e.key.replace("Arrow", "").toLowerCase());
      ...
      {gameOver && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-gray-800 px-8 py-4 rounded shadow-lg flex flex-col items-center">
            ...
            <button
              className="mt-2 p-2 bg-gray-800 hover:bg-orange-500 rounded-md text-white transition duration-300 ease-in-out transform hover:scale-105"
              onClick={handleNewGame}
            >
              Try Again
            </button>
